...
export default function CleanCodeSection() {
    return (
        <Box className="flex">
            <Paper elevation={0} square={true} className="basis-1/2 p-7">
                ...
                <p>
                    2. Vários estudos de casos na parte 2, cada vez mais complexos. Cada estudo de caso consiste em um exercício de refatoração de código. De acordo com o Bob, é a parte mais densa e intricada do livro, exige foco e paciência do leitor, e também revisão de páginas anteriores.
                </p>
            ...
            <Paper elevation={0} square={true} className="basis-1/2 p-7 flex flex-col justify-center bg-[#000]">
                <p>
                    O autor declara:
                </p>
                <br />
